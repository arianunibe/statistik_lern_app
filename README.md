...
**Inhalt:** 8 Kapitel aus den Vorlesungsskripten (Quellen: `txt\\\\\\\_files/`):
...
**Online (von überall):** https://arianunibe.github.io/statistik\_lern\_app
...
In `app.js` Zeile 3, Variable `API\\\\\\\_KEY`. Modell: `claude-haiku-4-5-20251001`.
